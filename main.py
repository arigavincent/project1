...
class NumberConverterApp(App):
    def build(self):
        ...
        self.input_text = TextInput(hint_text="Enter a number", background_color=(1, 1, 1, 0.8), foreground_color=(0, 0, 0, 1))
        self.output_label = Label(text="Converted number will appear here", color=(0, 0, 0, 1))

        self.converter_spinner = Spinner(text='From', values=('Binary', 'Octal', 'Decimal', 'Hexadecimal'), background_color=(1, 1, 1, 0.8))
        self.result_spinner = Spinner(text='To', values=('Binary', 'Octal', 'Decimal', 'Hexadecimal'), background_color=(1, 1, 1, 0.8))
